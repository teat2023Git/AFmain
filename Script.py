...
‣ ᴍʏ ɴᴀᴍᴇ : <a href=http://t.me/KMZoneMBot>𝗔𝗻𝗼𝗻𝘆𝗺𝗼𝘂𝘀 𝗠𝗼𝘃𝗶𝗲𝘀 𝗕𝗼𝘁</a>
 ...
 ‣ ʙᴜɪʟᴅ sᴛᴀᴛᴜs : ᴠ2.7.1 [sᴛᴀʙʟᴇ]></b>"""
    ...
    SOURCE_TXT = """
<b>Opps! </b> <i>Something went wrong. Please try again later.</i>"""
...
<b>ᴜʀʟ ʙᴜᴛᴛᴏɴꜱ:</b>
<code>[Button Text](buttonurl:https://t.me/LinkOpeningProcess/22)</code>
<b>ᴀʟᴇʀᴛ ʙᴜᴛᴛᴏɴꜱ:</b>
...
📌☣️𝐈𝐟 𝐘𝐨𝐮 𝐂𝐚𝐧 𝐍𝐨𝐭 𝐆𝐞𝐭 𝐘𝐨𝐮𝐫 𝐌𝐨𝐯𝐢𝐞 𝐉𝐮𝐬𝐭 𝐮𝐬𝐞 𝐓𝐡𝐢𝐬 𝐜𝐨𝐦𝐦𝐚𝐧𝐝: /request or /Request or #request or #Request 𝐭𝐡𝐞𝐧 𝐠𝐢𝐯𝐞 𝐚 𝐬𝐩𝐚𝐜𝐞 𝐭𝐡𝐞𝐧 𝐭𝐲𝐩𝐞 𝐲𝐨𝐮𝐫 𝐦𝐨𝐯𝐢𝐞 𝐧𝐚𝐦𝐞.
"""
...
📌☣️𝐈𝐟 𝐘𝐨𝐮 𝐂𝐚𝐧 𝐍𝐨𝐭 𝐆𝐞𝐭 𝐘𝐨𝐮𝐫 𝐌𝐨𝐯𝐢𝐞 𝐉𝐮𝐬𝐭 𝐮𝐬𝐞 𝐓𝐡𝐢𝐬 𝐜𝐨𝐦𝐦𝐚𝐧𝐝: 𝐈𝐟 𝐘𝐨𝐮 𝐂𝐚𝐧 𝐍𝐨𝐭 𝐆𝐞𝐭 𝐘𝐨𝐮𝐫 𝐌𝐨𝐯𝐢𝐞 𝐉𝐮𝐬𝐭 𝐮𝐬𝐞 𝐓𝐡𝐢𝐬 𝐜𝐨𝐦𝐦𝐚𝐧𝐝: /request or /Request or #request or #Request 𝐭𝐡𝐞𝐧 𝐠𝐢𝐯𝐞 𝐚 𝐬𝐩𝐚𝐜𝐞 𝐭𝐡𝐞𝐧 𝐭𝐲𝐩𝐞 𝐲𝐨𝐮𝐫 𝐦𝐨𝐯𝐢𝐞 𝐧𝐚𝐦𝐞.
"""

    MVE_NT_FND = """ᴍᴏᴠɪᴇ ɴᴏᴛ ꜰᴏᴜɴᴅ ɪɴ ᴅᴀᴛᴀʙᴀꜱᴇ😔...Dᴏɴ'ᴛ ᴡᴏʀʀʏ Aᴅᴍɪɴ Wɪʟʟ Uᴘʟᴏᴀᴅ ʏᴏᴜʀ Mᴏᴠɪᴇ Sᴏᴏɴ😃...or \n\n<b>You Can also Use [𝗥𝗲𝗾𝘂𝗲𝘀𝘁 𝗙𝗲𝗮𝘁𝘂𝗿𝗲]👇🏻</b> \n☀️𝐈𝐟 𝐘𝐨𝐮 𝐂𝐚𝐧 𝐍𝐨𝐭 𝐆𝐞𝐭 𝐘𝐨𝐮𝐫 𝐌𝐨𝐯𝐢𝐞 𝐉𝐮𝐬𝐭 𝐮𝐬𝐞 𝐓𝐡𝐢𝐬 𝐜𝐨𝐦𝐦𝐚𝐧𝐝: /request or /Request or #request or #Request 𝐭𝐡𝐞𝐧 𝐠𝐢𝐯𝐞 𝐚 𝐬𝐩𝐚𝐜𝐞 𝐭𝐡𝐞𝐧 𝐭𝐲𝐩𝐞 𝐲𝐨𝐮𝐫 𝐦𝐨𝐯𝐢𝐞 𝐧𝐚𝐦𝐞.  """
...
Tɪᴘ: Sᴇʟᴇᴄᴛ "Lᴀɴɢᴜᴀɢᴇs" ᴏʀ "Sᴇᴀsᴏɴs" Bᴜᴛᴛᴏɴ ᴀɴᴅ Cʟɪᴄᴋ "Sᴇɴᴅ Aʟʟ" Tᴏ ɢᴇᴛ Aʟʟ Fɪʟᴇ Lɪɴᴋs ɪɴ ᴀ Sɪɴɢʟᴇ ᴄʟɪᴄᴋ"""
    ...
    SINFO = """
🫣 itna kya soch rahe ho Join Channel Bro.. 🙂"""
...
☀️𝗠𝗲𝘀𝘀𝗮𝗴𝗲 <b>: {}</b>"""
    ...
    CAPTION = """<b>📂𝗙𝗶𝗹𝗲 𝗡𝗮𝗺𝗲 : <a href=https://t.me/KMZoneOfficial>{file_name}</a></b>
...
ஏய் <a href='tg://settings'>My Friend</a> 
 ...
 படி 1: இந்த MOVIE BOT போட் உங்கள் குழுவை நிர்வாகியாக்குங்கள்
...
Hey <a href='tg://settings'>My Friend</a> 
 ...
 Step 1: Administer this MOVIE BOT bot to your group
...
హే <a href='tg://settings'>My Friend</a> 
 ...
 దశ 1: ఈ MOVIE BOT బాట్‌ని మీ సమూహానికి నిర్వహించండి
...
अरे <a href='tg://settings'>My Friend</a> 
 ...
 चरण 1: इस MOVIE BOT बॉट को अपने समूह में प्रशासित करें
...
ഹേയ് <a href='tg://settings'>My Friend</a> 
 ...
 ഘട്ടം 1: ഈ MOVIE BOT ബോട്ട് നിങ്ങളുടെ ഗ്രൂപ്പിലേക്ക് നൽകുക
...
നിങ്ങളുടെ ടീം വീഡിയോ ശേഖരണവും പരിശീലിപ്പിക്കും..."""
 ...
 مرحلہ 1: اپنے گروپ میں اس MOVIE BOT بوٹ کا انتظام کریں۔
...
અરે <a href='tg://settings'>My Friend</a> 
 ...
 પગલું 1: તમારા જૂથમાં આ MOVIE BOT બોટનું સંચાલન કરો
...
ಹೇ {message.from_user.mention}
 ...
 ಹಂತ 1: ಈ MOVIE BOT ಬೋಟ್ ಅನ್ನು ನಿಮ್ಮ ಗುಂಪಿಗೆ ನಿರ್ವಹಿಸಿ
...
আরে <a href='tg://settings'>My Friend</a> 
 ...
 ধাপ 1: আপনার গ্রুপে এই MOVIE BOT বট পরিচালনা করুন

 ধাপ 2: আপনার ওয়েবসাইট এবং API যোগ করুন

 উদাহরণ: /shortlink omegalinks.in 4b392f8eb6ad711fbe58
