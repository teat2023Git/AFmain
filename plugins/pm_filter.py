...
async def give_filter(client, message):
    if message.chat.id != -1001907794132:
...
async def pm_text(bot, message):
    ...
    await message.reply_text(
         text=f"<b>ʜᴇʏ {user} 😍 ,\n\n𝗬𝗼𝘂 𝗖𝗮𝗻'𝘁 𝗚𝗲𝘁 𝗗𝗶𝗿𝗲𝗰𝘁 𝗠𝗼𝘃𝗶𝗲𝘀 𝗙𝗿𝗼𝗺 𝗛𝗲𝗿𝗲. ʀᴇǫᴜᴇsᴛ ɪᴛ ɪɴ ᴏᴜʀ <a href=https://t.me/+hO1NRiiL6ZJiZjA1>🌟𝗠𝗢𝗩𝗜𝗘 𝗚𝗥𝗢𝗨𝗣🌟</a> ᴏʀ ᴄʟɪᴄᴋ ʀᴇǫᴜᴇsᴛ ʜᴇʀᴇ ʙᴜᴛᴛᴏɴ ʙᴇʟᴏᴡ 👇</b>",   
         reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("📝 ʀᴇǫᴜᴇsᴛ ʜᴇʀᴇ ", url=f"https://t.me/+hO1NRiiL6ZJiZjA1")]])
    )
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        btn2 = [[
                 InlineKeyboardButton("↖️Vɪᴇᴡ Sᴛᴀᴛᴜs↗️", url=f"{query.message.link}")
               ]]
        ...
        btn2 = [[
                 ...
                 InlineKeyboardButton("🌟Rᴇᴏ̨ᴜᴇsᴛ Gʀᴏᴜᴘ Lɪɴᴋ🌟", url="https://t.me/+hO1NRiiL6ZJiZjA1")
               ]]
        if query.from_user.id in ADMINS:
            user = await client.get_users(from_user)
            reply_markup = InlineKeyboardMarkup(btn)
        ...
        if query.from_user.id in ADMINS:
            ...
            try:
                await client.send_message(chat_id=int(from_user), text=f"<b>Hᴇʏ {user.mention}, 𝗬𝗼𝘂𝗿 𝗥𝗲𝗾𝘂𝗲𝘀𝘁 𝗠𝗼𝘃𝗶𝗲: `{content}` 𝗜𝘀 🟢𝗔𝗹𝗿𝗲𝗮𝗱𝘆 𝗔𝘃𝗮𝗶𝗹𝗮𝗯𝗹𝗲 𝗢𝗻 𝗢𝘂𝗿 𝗕𝗼𝘁'𝘀 𝗗𝗮𝘁𝗮𝗯𝗮𝘀𝗲. \n\n𝐘𝐨𝐮 𝐰𝐞𝐫𝐞 𝐮𝐧𝐚𝐛𝐥𝐞 𝐭𝐨 𝐠𝐞𝐭 𝐢𝐭 𝐛𝐞𝐜𝐚𝐮𝐬𝐞 𝐨𝐟 𝐲𝐨𝐮𝐫 𝐬𝐩𝐞𝐥𝐥𝐢𝐧𝐠 𝐦𝐢𝐬𝐭𝐚𝐤𝐞🧐. 𝐏𝐥𝐞𝐚𝐬𝐞 𝐦𝐚𝐤𝐞 𝐬𝐮𝐫𝐞 𝐲𝐨𝐮'𝐯𝐞 𝐬𝐩𝐞𝐥𝐥𝐞𝐝 𝐜𝐨𝐫𝐫𝐞𝐜𝐭𝐥𝐲 𝐰𝐡𝐢𝐥𝐞 𝐬𝐞𝐚𝐫𝐜𝐡𝐢𝐧𝐠 𝐜𝐨𝐧𝐭𝐞𝐧𝐭 𝐢𝐧 𝐠𝐫𝐨𝐮𝐩... \n\n𝗞𝗶𝗻𝗱𝗹𝘆 𝗦𝗲𝗮𝗿𝗰𝗵 𝗮𝗴𝗮𝗶𝗻 𝘄𝗶𝘁𝗵 𝗰𝗼𝗿𝗿𝗲𝗰𝘁 𝘀𝗽𝗲𝗹𝗹𝗶𝗻𝗴 𝗜𝗻 𝗢𝘂𝗿 𝗚𝗿𝗼𝘂𝗽.</b>", reply_markup=InlineKeyboardMarkup(btn2))
            except UserIsBlocked:
    ...
    # don't change anything without contacting me @creatorrio
        ...
        await query.message.edit_text(
            ...
            btn = [[
                    InlineKeyboardButton("⟸ Bᴀᴄᴋ", callback_data="help"),
                    InlineKeyboardButton("Cᴏɴᴛᴀᴄᴛ", url="https://t.me/FilmyWorld2023bot")
                  ]]
            await client.edit_message_media(
                query.message.chat.id, 
                query.message.id, 
