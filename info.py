...
auth_channel = environ.get('AUTH_CHANNEL', '-1001756351913')
auth_grp = environ.get('AUTH_GROUP', '-1001918797443')
...
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+cCkYYp-y1MtkMzc1')
